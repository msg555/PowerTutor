...
import edu.umich.PowerTutor2.R;
import edu.umich.PowerTutor2.service.ICounterService;
import edu.umich.PowerTutor2.ui.PowerTabs;
import edu.umich.PowerTutor2.ui.UMLogger;
...
//android.os.Debug.stopMethodTracing();
  ...
  public void showNotification(){
    ...
    // icon from resources
    CharSequence tickerText = "PowerTutor2";              // ticker-text
    long when = System.currentTimeMillis();         // notification time
    Context context = getApplicationContext();      // application Context
    CharSequence contentTitle = "PowerTutor2";  // expanded message title
